...
namespace ThirdPersonCamera
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if(target.GetComponent<CharacterControllerLogic>().isCrawling || target.GetComponent<CharacterControllerLogic>().isForcedCrawling)
            {
                distance = 0;
                ...
                //target.GetComponentsInChildren<SkinnedMeshRenderer>().enabled = false;
                offsetVector = new Vector3(0f,0.9f,0f);
            }
            else
            {
                distance = desiredDistance;
                ...
                offsetVector = new Vector3(0f, 1.5f, 0f);
            }
